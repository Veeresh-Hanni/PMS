...
from . import views
from . import pharmacistViews, DoctorViews, patient_view, clerkViews
...
urlpatterns = [
    ...
    path('admin_user/admitted_today/', HODViews.admitted_today, name='admitted_today'),

    # New routes for patient registration and prescription upload

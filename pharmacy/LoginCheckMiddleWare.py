...
class LoginCheckMiddleWare(MiddlewareMixin):
    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        if user.is_authenticated:
            ...
            if request.path == reverse("login") or request.path == reverse("reset_password") or request.path == reverse("password_reset_done") or request.path == reverse("password_reset_complete")or request.path in [reverse("reset_password"), reverse("register_patient"), reverse("upload_prescription"), reverse("password_reset_done"),reverse("password_reset_complete") ]:
                pass
            else:
                return redirect("login")

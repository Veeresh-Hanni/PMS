...
class CustomUser(AbstractUser):
    groups = models.ManyToManyField(
        'auth.Group',
        related_name='customuser_groups',  # Updated related_name to avoid clash
        blank=True,
    ...
    user_permissions = models.ManyToManyField(
        'auth.Permission',
        related_name='customuser_user_permissions',  # Updated related_name to avoid clash
        blank=True,
...
class Prescription(models.Model):
    ...
    file = models.FileField(upload_to='prescriptions/', null=True, blank=True)  # Add this line
